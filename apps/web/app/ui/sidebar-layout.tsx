      ...
      <nav className="relative">
        <Collapsible.Trigger asChild>
          <div className="flex w-full px-4 md:hidden">
            {open ? (
              <button className="absolute top-1 right-1 inline-flex items-center justify-center rounded-md p-2 text-pink-900 hover:bg-gray-700 hover:text-white focus:outline-hidden focus:ring-2 focus:ring-white focus:ring-inset">
